...
So if you're interested in getting statisticians to use your model, then
...
Is it worthwhile recoding in SAS? Will you learn R or SAS sufficient to be able 
to share your model?

`<DIGRESSION>`
*I have been involved in discussions in the past within the statistics community
about "validation" of R and analysis done with R. The misconception was that 
analysis performed with R had to be replicated using SAS in order for it to be 
"validated" and accepted by regulatory agencies. See 
[here](http://www.slideshare.net/MikeKSmith/r-eliminating-fear-uncertainty-and-doubt)
for more discussion on this topic. But if we follow that argument through,
why aren't people insisting that we re-run NONMEM analyses using PROC NLMIXED?*
`</end DIGRESSION>`
...
For a moment, just compare the growth our community in pharmacometrics made in
comparison to other fields such as computational biology, genetics, ecology to 
name a few. The experts in these fields are scientists, similar to us, and 
not software engineers. Yet, they made massive strides in science mainly due to 
their adoption of open source methods and tools. Experts working in the industry 
put their developed tools and materials out in the open, a culture that 
pharmacometrics experts in the industry have yet to embrace after all these years.

The fundamental requirement is a change in culture and thinking in our community. 
To facilitate getting over the initial hurdles of this culture change, tools that 
allow this transition are required.

The DDMoRe model exchange standards could be revolutionary for model sharing and 
interoperability within the pharmacometrics discipline but also beyond into other 
quantitative disciplines e.g. statistics.
