...
disciplines are now involved either in building models, evaluating models,
using models and modelling outputs to interpret data, plan studies, make 
...
used for prediction and simulation of new designs, regimens, scenarios there 
...
supported product by the company that bought it from Insightful. And yet, here
...
(SBML)[http://authors.library.caltech.edu/2099/1/HUCieesb04.pdf] has had a 
...
In a similar way, the DDMoRe model exchange standards could be revolutionary
for model sharing and interoperability within the pharmacometrics discipline
but also beyond into other quantitative disciplines e.g. statistics.
...
MDL, along with the DDMoRe model exchange standards, [has shown to achieve 
